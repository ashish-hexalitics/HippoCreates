...
function Sidebar() {
  ...
  const routes = [
    ...
    {
      path: "/build-resume/additional-details",
      icon: GrDocumentUser,
  ...
  return (
    <div className="flex md:flex-col flex-row justify-between items-center md:h-full h-[70px] w-full md:w-[100px] lg:w-[100px] bg-white text-white shadow-lg fixed md:relative top-0 md:top-auto z-10">
